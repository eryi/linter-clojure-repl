// Based on: https://github.com/rksm/node-nrepl-client/blob/master/src/nrepl-client.js
...
function nreplSend(socket, messageStream, msgSpec, callback) {
    ...
    function msgHandler(_messages) {
        var done = _messages.some(function(msg) { return msg.status && msg.status.indexOf("done") > -1; });
